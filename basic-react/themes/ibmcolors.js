...
**/
export const ibmBluePale = '#57A8FD';
export const ibmBlue = '#3E76C0'; // standard button
export const ibmBlueDark = '#305B81'; // button hover and enter
...
export const ibmWhite = '#FFFFFF'; // Pure white
export const ibmBlack = '#000000'; // Pure black
